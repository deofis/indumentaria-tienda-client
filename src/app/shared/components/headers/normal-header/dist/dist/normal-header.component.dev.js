...
function () {
  ...
  NormalHeaderComponent.prototype.ngOnInit = function () {
    ...
    this.verificarSesion(); //to keep seeing the scroll and adjust the header opacity
    // window.addEventListener("scroll",this.headerEffect)
    // get category list 

    this.getListaCategorias(); //cart counter
  ...
  NormalHeaderComponent.prototype.verificarSesion = function () {
    ...
    this.authService.loggedIn.subscribe(function (resp) {
      return _this.estaLogueado = resp;
    });
  ...
  NormalHeaderComponent.prototype.logout = function () {
    ...
    this.authService.logout().subscribe(function (response) {
      sweetalert2_1["default"].fire({
        ...
        _this.router.navigate(['/home']); // refresh

      });
    });
  };

  NormalHeaderComponent = __decorate([core_1.Component({
